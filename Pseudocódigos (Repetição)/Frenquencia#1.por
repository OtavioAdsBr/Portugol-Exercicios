programa
{
    funcao inicio()
    {
        ...
        inteiro aprovados = 0, recuperacao = 0, reprovados = 0, contadorAluno = 0, aluno = 0
		...
		faca{
		  ...
		  escreva("Digite a nota do aluno ", ": ")
            ...
            senao se (nota >= 40 e nota < 60 e frequencia >= 75) {
                    recuperacao = recuperacao + 1
            }
            senao se (nota >= 60 e frequencia >= 75) {
                        aprovados = aprovados + 1
            } 
		}enquanto (contadorAluno < 108)
